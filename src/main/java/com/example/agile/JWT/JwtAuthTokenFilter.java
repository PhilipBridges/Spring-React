...
// JwtAuthTokenFilter extracts username/password from the received token using JwtProvider,
// then based on the extracted data, JwtAuthTokenFilter:
//  – creates an AuthenticationToken (that implements Authentication)
//  – uses the AuthenticationToken as an Authentication object and stores it in the SecurityContext
